					...
					<div class="table-container">
						<form method="POST" action="{{ route('productos.update',$producto->id) }}"  role="form">
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="sku" id="sku" class="form-control input-sm" value="{{$producto->sku}}">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="categoria" id="id_categoria" class="form-control input-sm" value="{{$producto->id_categoria}}">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="stock" id="stock" class="form-control input-sm" value="{{$producto->stock}}">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
